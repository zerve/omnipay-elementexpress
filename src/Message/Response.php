...
class Response extends AbstractResponse
{
    ...
    /**
     * Get the ReferenceNumber as generated by the merchant website.
     *
     * @return string
     */
     ...
     * Transaction ID
     *
     * @return null|string A transaction ID provided by the gateway
     */
     ...
     * Payment Account ID
     *
     * @return null|string Payment account ID in tokenized transactions.
     */
