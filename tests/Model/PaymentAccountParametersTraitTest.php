...
class MockPaymentAccountParametersTraitImplementation extends AbstractRequest
{
...
class PaymentAccountParametersTraitTest extends AbstractTraitTestCase
{
    public function getMockRequest()
    {
        ...
        if (null === $this->mockRequest) {
            $this->mockRequest = new MockPaymentAccountParametersTraitImplementation($client, $request);
        }
